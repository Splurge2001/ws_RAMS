...
class Metaclass_MoveToPose_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('rams_interface')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_MoveToPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rams_interface.srv import _move_to_pose
...
class MoveToPose(metaclass=Metaclass_MoveToPose):
    from rams_interface.srv._move_to_pose import MoveToPose_Request as Request
    from rams_interface.srv._move_to_pose import MoveToPose_Response as Response
