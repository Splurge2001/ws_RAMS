...
#ifndef RAMS_INTERFACE__SRV__DETAIL__MOVE_TO_POSE__FUNCTIONS_H_
#define RAMS_INTERFACE__SRV__DETAIL__MOVE_TO_POSE__FUNCTIONS_H_
...
#include "rams_interface/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_rams_interface
bool
 ...
 * calls
 * rams_interface__srv__MoveToPose_Request__init().
...
/**
 * It calls
 * rams_interface__srv__MoveToPose_Request__fini()
 ...
 * rams_interface__srv__MoveToPose_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * rams_interface__srv__MoveToPose_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rams_interface__srv__MoveToPose_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rams_interface
...
/**
 * It calls
 * rams_interface__srv__MoveToPose_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rams_interface
...
/**
 * It allocates the memory for the array and calls
 * rams_interface__srv__MoveToPose_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rams_interface
...
/**
 * It calls
 * rams_interface__srv__MoveToPose_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // RAMS_INTERFACE__SRV__DETAIL__MOVE_TO_POSE__FUNCTIONS_H_
